...
@keyframes steamRise {
  ...
  15%  { opacity: .55; }
  50%  { transform: translateY(-14px) scaleX(1.15); opacity: .35; }
  100% { transform: translateY(-30px) scaleX(0.9); opacity: 0; }
}
.steam-path { animation: steamRise 3.4s ease-in-out infinite; transform-origin: bottom center; }
.steam-path.delay-1 { animation-delay: .9s; }
.steam-path.delay-2 { animation-delay: 1.8s; }
...
@media (prefers-reduced-motion: reduce) {
  .steam-path, .marquee-track, .reveal { animation: none !important; }
}
`;
